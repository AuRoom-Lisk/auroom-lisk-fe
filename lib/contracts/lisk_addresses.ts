...
export const LISK_CONTRACTS = {
  // ===== TOKENS =====
  IDRX: "0xCd88C2886A1958BA36238A070e71B51CF930b44d" as const,
  ...
  // ===== LIQUIDITY PAIRS =====
  IDRX_USDC_Pair: "0x478FA3880F8474E50ECEDDA71a1D56d5560b1E3f" as const,
  ...
  BorrowingProtocolV2: "0xA89448b60C4771Fe0C38ba29000AbFdB85E1f6aF" as const,

  // Alias for backward compatibility (V1 doesn't exist on Lisk, so we point to V2)
  BorrowingProtocol: "0xA89448b60C4771Fe0C38ba29000AbFdB85E1f6aF" as const,
} as const;
